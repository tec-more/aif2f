...
/// generated route for
/// [InterpretView]
class InterpretRoute extends PageRouteInfo<void> {
  const InterpretRoute({List<PageRouteInfo>? children})
    : super(InterpretRoute.name, initialChildren: children);

  static const String name = 'InterpretRoute';
